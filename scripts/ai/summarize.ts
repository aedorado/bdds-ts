...
/**
 * Script to generate AI summaries for a lecture
 * Usage: npx tsx scripts/ai/summarize.ts --lectureId=123
 */
async function main() {
  ...
  if (!lectureIdArg) {
    console.error('Usage: npx tsx scripts/ai/summarize.ts --lectureId=123')
    process.exit(1)
  }
