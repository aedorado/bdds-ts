      ...
      <div className="fixed inset-0 z-50 bg-background flex flex-col">
        ...
        {hasMedia && playerOpen && (
          <div className={`
            ...
            sm:bottom-4 sm:right-4 sm:left-auto sm:w-96 sm:rounded-xl
          `}>
            {/* Titlebar */}
            <div
              className="flex items-center justify-between px-3 py-2.5 bg-slate-800 cursor-pointer select-none rounded-t-xl"
